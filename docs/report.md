...
Проект использует нераспределенную стратегию развертывания — все компоненты приложения работают в рамках одного процесса на устройстве конечного пользователя.
